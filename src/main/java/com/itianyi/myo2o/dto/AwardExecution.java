package com.itianyi.myo2o.dto;

import java.util.List;

import com.itianyi.myo2o.entity.Award;
import com.itianyi.myo2o.enums.AwardStateEnum;
...
public class AwardExecution {
	...
	//成功的构造器
	public AwardExecution(AwardStateEnum stateEnum , List<Award> arwardList){
		this.state = stateEnum.getState();
		this.stateInfo = stateEnum.getStateInfo();
